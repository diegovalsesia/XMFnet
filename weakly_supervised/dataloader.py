...
if __name__ == "__main__":
    ...
    ViPCDataset = ViPCDataLoader2('test_list2.txt',data_path='/home/aiello/ShapeNetViPC-Dataset',status='test', category = 'plane')
