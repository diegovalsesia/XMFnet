...
cd supervised/decoder/utils/furthestPointSampling
python3 setup.py install

# https://github.com/stevenygd/PointFlow/tree/master/metrics --> not used
cd supervised/decoder/utils/metrics/pytorch_structural_losses
make

# https://github.com/sshaoshuai/Pointnet2.PyTorch
cd supervised/decoder/utils/Pointnet2.PyTorch/pointnet2
python3 setup.py install

# https://github.com/daerduoCarey/PyTorchEMD
cd supervised/decoder/utils/PyTorchEMD
python3 setup.py install

# used to generate partialized partial inputs
cd supervised/decoder/utils/randPartial
python3 setup.py install
